...
import semester.service.chatwork.domain.service.v0.parser.{ParticipantParser, RoomParser}
import semester.service.chatwork.domain.service.v0.request.GetRoomInfoRequest
import semester.service.chatwork.domain.service.v0.response.GetRoomInfoResponse
