package etude.commons.domain.money

import java.util.{Currency => JavaCurrency, Locale}
import etude.commons.domain.ValueObject

case class Currency(javaCurrency: JavaCurrency, fractionDigits: Int) extends ValueObject {
