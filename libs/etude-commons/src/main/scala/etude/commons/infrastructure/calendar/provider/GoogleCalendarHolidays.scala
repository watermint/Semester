package etude.commons.infrastructure.calendar.provider
...
import etude.commons.domain.calendar.{NationalHoliday, Holiday, CalendarDateSpan}
import etude.commons.domain.region.Country
import etude.commons.infrastructure.calendar.{CalendarLoadException, NoCalendarFoundException}
import etude.commons.infrastructure.http.{StatusInternalServerError, StatusSuccessful, Client}
