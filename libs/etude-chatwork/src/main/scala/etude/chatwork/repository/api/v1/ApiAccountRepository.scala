...
import etude.chatwork.repository.{AccountRepository, EntityNotFoundException}

case class ApiAccountRepository(implicit authToken: TokenAuthentication) extends AccountRepository with ApiQoS {
