package etude.table.arrabbiata.ui.dialog

import javafx.event.ActionEvent

import etude.table.arrabbiata.controller.AppActor
import etude.table.arrabbiata.controller.message.session.Login
import etude.table.arrabbiata.ui.message.micro.session.LoginHide
import etude.table.arrabbiata.ui.{UIActor, UIUnit}
