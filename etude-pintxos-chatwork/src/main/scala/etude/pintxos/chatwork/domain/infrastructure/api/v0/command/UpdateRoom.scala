...
import etude.pintxos.chatwork.domain.infrastructure.api.v0.request.UpdateRoomRequest
import etude.pintxos.chatwork.domain.infrastructure.api.v0.response.UpdateRoomResponse
