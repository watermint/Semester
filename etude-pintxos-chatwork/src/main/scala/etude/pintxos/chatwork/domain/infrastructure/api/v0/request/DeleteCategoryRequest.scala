...
import etude.pintxos.chatwork.domain.infrastructure.api.v0.command.DeleteCategory
import etude.pintxos.chatwork.domain.infrastructure.api.v0.response.{ChatWorkResponse, DeleteCategoryResponse}
