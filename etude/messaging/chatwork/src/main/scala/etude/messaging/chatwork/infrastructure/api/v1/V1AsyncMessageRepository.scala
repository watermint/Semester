...
import etude.messaging.chatwork.domain.message.{AsyncMessageRepository, Message, MessageId}
import etude.messaging.chatwork.domain.room.RoomId
import etude.messaging.chatwork.infrastructure.api.{ApiQoS, NotImplementedException}
import org.json4s._
...
class V1AsyncMessageRepository
  ...
  type This <: V1AsyncMessageRepository
